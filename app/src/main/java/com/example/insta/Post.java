...
public class Post extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        desc=view.findViewById(R.id.edtDesc);
        post=view.findViewById(R.id.btnShare);

        shareImg.setOnClickListener(Post.this);
        post.setOnClickListener(Post.this);
        ...
        switch (v.getId()){
            ...
            case R.id.btnShare:
                if (receivedImageBitmap == null){
                    Toast.makeText(getContext(),"Image to be selected",Toast.LENGTH_SHORT).show();
